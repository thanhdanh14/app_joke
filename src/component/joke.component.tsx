...
export default function JokeApp() {
  ...
  return (
    <div className=''>
      ...
      <div className='bg-green-600 h-40 text-center'>
        <h1 className='font-bold text-white text-3xl pt-9'>A joke a day keeps the doctor away</h1>
      ...
      <div className='flex gap-2 justify-center mt-[50px]'>
        <button
          ...
          className='bg-blue-700 h-[50px] w-[300px] text-center rounded-none text-white font-medium'
        >
          This is Funny!
        </button>
        <button
          ...
          disabled={contentIndex === contents.length - 1}
          className='bg-green-600 h-[50px] w-[300px] text-center rounded-none text-white font-medium'
        >
          This is not funny.
        </button>
      </div>
